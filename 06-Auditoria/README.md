...
| # | Captura | Qué muestra |
|---|---|---|
| 1 | [`01-Evento-4720-Cuenta-Creada.jpg`](Evidencias/01-Evento-4720-Cuenta-Creada.jpg) | Event ID 4720 — creación de la cuenta `mlopez`, sujeto `TECHSOLUTIONS\Administrador`. |
| 2 | [`02-Evento-4722-Cuenta-Habilitada.jpg`](Evidencias/02-Evento-4722-Cuenta-Habilitada.jpg) | Event ID 4722 — habilitación de la cuenta `mlopez`. |
| 3 | [`03-Evento-4728-Alta-en-Grupo.jpg`](Evidencias/03-Evento-4728-Alta-en-Grupo.jpg) | Event ID 4728 — alta de `mlopez` como miembro de un grupo global. |
